 ...
 * @author USUARIO
 */
public class cuestionario4 extends JFrame{
    ...
    public cuestionario4(){
        ...
        if(variables.idioma == 0){
            tituloP1.setText(llamar.pregunta4);
            preguntaP1.setText(llamar.pregunta4_pre);
            respuestaA.setText(llamar.pregunta4OpcA_pre);
            respuestaB.setText(llamar.pregunta4OpcB_pre);
            respuestaC.setText(llamar.pregunta4OpcC_pre);
            siguiente.setText(llamar.botonCont_cont);
            English.setText(llamar.ingles);
            espanol.setText(llamar.espanol);
        } else {
            tituloP1.setText(llamar.pregunta4_ENG);
            preguntaP1.setText(llamar.pregunta4_preENG);
            respuestaA.setText(llamar.pregunta4OpcA_preENG);
            respuestaB.setText(llamar.pregunta4OpcB_preENG);
            respuestaC.setText(llamar.pregunta4OpcC_preENG);
        ...
        MouseListener Eve = new MouseListener() {
            ...
            public void mousePressed(MouseEvent e) {
                cuestionario5 next = new cuestionario5();
                if (respuestaA.isSelected()) {
                    setVisible(false);
                    next.setVisible(true);
                } else if (respuestaB.isSelected()) {
                    variables.nota++;
                    variables.respuestaC[3] = 1;
                    setVisible(false);
                    next.setVisible(true);
