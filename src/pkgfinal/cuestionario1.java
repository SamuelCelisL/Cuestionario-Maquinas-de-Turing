 ...
 * @author USUARIO
 */
public class cuestionario1 extends JFrame{
    ...
    public cuestionario1(){
        ...
        if(variables.idioma == 0){
            tituloP1.setText(llamar.pregunta1);
            preguntaP1.setText(llamar.pregunta1_pre);
            respuestaA.setText(llamar.pregunta1OpcA_pre);
            respuestaB.setText(llamar.pregunta1OpcB_pre);
            respuestaC.setText(llamar.pregunta1OpcC_pre);
            siguiente.setText(llamar.botonCont_cont);
            English.setText(llamar.ingles);
            espanol.setText(llamar.espanol);
        } else {
            tituloP1.setText(llamar.pregunta1_ENG);
            preguntaP1.setText(llamar.pregunta1_preENG);
            respuestaA.setText(llamar.pregunta1OpcA_preENG);
            respuestaB.setText(llamar.pregunta1OpcB_preENG);
            respuestaC.setText(llamar.pregunta1OpcC_preENG);
        ...
        MouseListener Eve = new MouseListener() {
            ...
            public void mousePressed(MouseEvent e) {
                cuestionario2 next = new cuestionario2();
                if (respuestaA.isSelected()) {
                    setVisible(false);
                    next.setVisible(true);
                } else if (respuestaB.isSelected()) {
                    variables.nota++;
                    variables.respuestaC[0] = 1;
                    setVisible(false);
                    next.setVisible(true);
