 ...
 * @author USUARIO
 */
public class cuestionario3 extends JFrame{
    ...
    public cuestionario3(){
        ...
        if(variables.idioma == 0){
            tituloP1.setText(llamar.pregunta3);
            preguntaP1.setText(llamar.pregunta3_pre);
            respuestaA.setText(llamar.pregunta3OpcA_pre);
            respuestaB.setText(llamar.pregunta3OpcB_pre);
            respuestaC.setText(llamar.pregunta3OpcC_pre);
            siguiente.setText(llamar.botonCont_cont);
            English.setText(llamar.ingles);
            espanol.setText(llamar.espanol);
        } else {
            tituloP1.setText(llamar.pregunta3_ENG);
            preguntaP1.setText(llamar.pregunta3_preENG);
            respuestaA.setText(llamar.pregunta3OpcA_preENG);
            respuestaB.setText(llamar.pregunta3OpcB_preENG);
            respuestaC.setText(llamar.pregunta3OpcC_preENG);
        ...
        MouseListener Eve = new MouseListener() {
            ...
            public void mousePressed(MouseEvent e) {
                cuestionario4 next = new cuestionario4();
                if (respuestaA.isSelected()) {
                    setVisible(false);
                    next.setVisible(true);
                } else if (respuestaB.isSelected()) {
                    variables.nota++;
                    variables.respuestaC[2] = 1;
                    setVisible(false);
                    next.setVisible(true);
