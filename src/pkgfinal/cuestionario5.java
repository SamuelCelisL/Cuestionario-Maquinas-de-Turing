 ...
 * @author USUARIO
 */
public class cuestionario5 extends JFrame{
    
    public void calificacion(){
        resultado next = new resultado();
        setVisible(false);
    ...
    public cuestionario5(){
        ...
        if(variables.idioma == 0){
            tituloP1.setText(llamar.pregunta5);
            preguntaP1.setText(llamar.pregunta5_pre);
            respuestaA.setText(llamar.pregunta5OpcA_pre);
            respuestaB.setText(llamar.pregunta5OpcB_pre);
            respuestaC.setText(llamar.pregunta5OpcC_pre);
            siguiente.setText(llamar.botonCont_cont);
            English.setText(llamar.ingles);
            espanol.setText(llamar.espanol);
        } else {
            tituloP1.setText(llamar.pregunta5_ENG);
            preguntaP1.setText(llamar.pregunta5_preENG);
            respuestaA.setText(llamar.pregunta5OpcA_preENG);
            respuestaB.setText(llamar.pregunta5OpcB_preENG);
            respuestaC.setText(llamar.pregunta5OpcC_preENG);
